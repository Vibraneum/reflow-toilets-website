...
const products: ProductSpec[] = [
  {
    ...
    image: '/images/units/reflow mini.png',
  ...
  {
    name: '40ft B-CRT Hub',
    tagline: 'District Sanitation Center - Gates Foundation Award Winner',
    image: 'https://res.cloudinary.com/dhupieu4x/image/upload/v1763732619/reflow-assets/bcrt/main-bcrt.jpg',
    ...
    dailyUsers: '300+ users/day',
    costRange: '₹₹₹ (Premium)',
    features: [
      '8-stage ISO30500 water treatment (2,000-3,000L/day)',
      'Zero-sewage discharge - 95-98% water recovery',
      'Solar power: 9 panels (4.05kWp) + 20kWh battery (72+ hours off-grid)',
      '35+ IoT monitoring points with remote management',
      'Sludge treatment: >90% volume reduction, Class A biosolids',
      'Gates Foundation award-winning technology',
    ],
